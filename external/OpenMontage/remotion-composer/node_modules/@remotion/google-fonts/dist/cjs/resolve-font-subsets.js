...
exports.resolveFontSubsetKeys = void 0;
const isChunkSubset = (subset) => /^\[\d+\]$/.test(subset);
const compareChunkSubsets = (a, b) => {
 ...
 */
const resolveFontSubsetKeys = ({ availableSubsetKeys, metaSubsets, requestedSubset, }) => {
...
exports.resolveFontSubsetKeys = resolveFontSubsetKeys;
