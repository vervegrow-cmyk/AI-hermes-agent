...
import {
  DroneTikTokVertical,
  DroneTikTokVerticalProps,
  calculateDroneTikTokVerticalMetadata,
} from "./DroneTikTokVertical";
...
export const Root: React.FC = () => {
  return (
    <>
      ...
      />
      <Composition
        id="DroneTikTokVertical"
        component={DroneTikTokVertical}
        durationInFrames={30 * 30}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{
          productName: "Drone Product",
          cta: "Tap to shop",
          scenes: [],
          captions: [],
          audio: {},
        } as DroneTikTokVerticalProps}
        calculateMetadata={calculateDroneTikTokVerticalMetadata}
      />
      <Composition
        id="EndTag"
        component={EndTag}
