...
// src/react/AutumnContext.tsx
var import_react = require("react");
var AutumnContext = (0, import_react.createContext)(null);
var useAutumnClient = ({
  caller
}) => {
...
var useCustomerActions = ({
  ...
  const attach = (0, import_react3.useCallback)(
    async (params) => {
  ...
  const previewAttach = (0, import_react3.useCallback)(
    async (params) => {
      return client.previewAttach(params);
    },
    [client]
  );
  const updateSubscription = (0, import_react3.useCallback)(
    async (params) => {
  ...
  const previewUpdateSubscription = (0, import_react3.useCallback)(
    async (params) => {
      return client.previewUpdateSubscription(params);
    },
    [client]
  );
  const check = (0, import_react3.useCallback)(
    (params) => {
  ...
  const openCustomerPortal = (0, import_react3.useCallback)(
    async (params = {}) => {
  ...
  const multiAttach = (0, import_react3.useCallback)(
    async (params) => {
  ...
  const previewMultiAttach = (0, import_react3.useCallback)(
    async (params) => {
      return client.previewMultiAttach(params);
    },
    [client]
  );
  const setupPayment = (0, import_react3.useCallback)(
    async (params = {}) => {
...
// src/react/hooks/useEntity.ts
var useEntity = (params) => {
...
// src/react/hooks/useListEvents.ts
...
var useListEvents = (params = {}) => {
  ...
  const goToPage = (0, import_react4.useCallback)(({ pageNum }) => {
    setPage(Math.max(0, pageNum));
  }, []);
  const resetPagination = (0, import_react4.useCallback)(() => {
    setPage(0);
  }, []);
...
// src/react/hooks/useReferrals.ts
var import_react5 = require("react");
var useReferrals = (params) => {
  ...
  const queryResult = useQuery({
    ...
    queryFn: () => client.createReferralCode({
      programId
    }),
    enabled: false,
    ...queryOptions
  });
  const redeemCode = (0, import_react5.useCallback)(
    async (redeemParams) => {
