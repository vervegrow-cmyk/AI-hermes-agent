...
async function toNetworkScopedEvmServerAccount(options) {
    ...
    if ((0, networkCapabilities_js_1.isMethodSupportedOnNetwork)("quoteFund", resolvedNetworkName)) {
        Object.assign(account, {
    ...
    if ((0, networkCapabilities_js_1.isMethodSupportedOnNetwork)("fund", resolvedNetworkName)) {
        Object.assign(account, {
    ...
    if ((0, networkCapabilities_js_1.isMethodSupportedOnNetwork)("useSpendPermission", resolvedNetworkName)) {
        Object.assign(account, {
            __experimental_useSpendPermission: async (spendPermissionOptions) => {
                analytics_js_1.Analytics.trackAction({
