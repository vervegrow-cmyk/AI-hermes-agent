...
export const getGetEvmSwapPriceResponseGetSwapPriceResponseMock = (overrideResponse = {}) => ({
    ...{
        ...{
...
export const getGetEvmSwapPriceResponseSwapUnavailableResponseMock = (overrideResponse = {}) => ({
    ...{ liquidityAvailable: faker.datatype.boolean() },
    ...overrideResponse,
});
export const getGetEvmSwapPriceResponseMock = () => faker.helpers.arrayElement([
    { ...getGetEvmSwapPriceResponseGetSwapPriceResponseMock() },
    { ...getGetEvmSwapPriceResponseSwapUnavailableResponseMock() },
]);
export const getCreateEvmSwapQuoteResponseCreateSwapQuoteResponseMock = (overrideResponse = {}) => ({
    ...{
        ...{
            permit2: {
...
export const getCreateEvmSwapQuoteResponseSwapUnavailableResponseMock = (overrideResponse = {}) => ({
    ...{ liquidityAvailable: faker.datatype.boolean() },
    ...overrideResponse,
});
export const getCreateEvmSwapQuoteResponseMock = () => faker.helpers.arrayElement([
    { ...getCreateEvmSwapQuoteResponseCreateSwapQuoteResponseMock() },
    { ...getCreateEvmSwapQuoteResponseSwapUnavailableResponseMock() },
]);
export const getGetEvmSwapPriceMockHandler = (overrideResponse) => {
    return http.get("*/v2/evm/swaps/quote", async (info) => {
        ...
        return new HttpResponse(JSON.stringify(overrideResponse !== undefined
            ? typeof overrideResponse === "function"
                ...
                : overrideResponse
            : getGetEvmSwapPriceResponseMock()), { status: 200, headers: { "Content-Type": "application/json" } });
    });
};
export const getCreateEvmSwapQuoteMockHandler = (overrideResponse) => {
    return http.post("*/v2/evm/swaps", async (info) => {
        ...
        return new HttpResponse(JSON.stringify(overrideResponse !== undefined
            ? typeof overrideResponse === "function"
                ? await overrideResponse(info)
                : overrideResponse
            : getCreateEvmSwapQuoteResponseMock()), { status: 201, headers: { "Content-Type": "application/json" } });
    });
};
