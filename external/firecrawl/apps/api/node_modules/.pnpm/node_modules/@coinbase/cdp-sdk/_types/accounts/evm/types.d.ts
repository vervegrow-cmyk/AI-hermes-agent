...
} : EmptyObject) & (Network extends SpendPermissionNetworks ? {
    __experimental_useSpendPermission: (options: Omit<UseSpendPermissionOptions, "network">) => Promise<SendUserOperationReturnType>;
} : EmptyObject)>;
/**
...
export type NetworkSpecificAccountActions<Network extends string> = Prettify<{
    ...
    __experimental_useSpendPermission: (options: Omit<UseSpendPermissionOptions, "network">) => Promise<TransactionResult>;
} : EmptyObject)>;
/**
