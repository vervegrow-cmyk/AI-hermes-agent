import { b as ClosedEnum, O as OpenEnum, G as GetOrCreateCustomerParams, R as ResolvedIdentity } from './authTypes-CyV4xBTB.mjs';
 ...
 */
declare const AttachResetInterval: {
    readonly OneOff: "one_off";
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
type AttachResetInterval = ClosedEnum<typeof AttachResetInterval>;
/**
...
declare const AttachTierBehavior: {
    readonly Graduated: "graduated";
    readonly Volume: "volume";
};
type AttachTierBehavior = ClosedEnum<typeof AttachTierBehavior>;
/**
 ...
 */
declare const AttachBillingMethod: {
 ...
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
type AttachBillingMethod = ClosedEnum<typeof AttachBillingMethod>;
/**
 ...
 */
declare const AttachOnIncrease: {
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
type AttachOnIncrease = ClosedEnum<typeof AttachOnIncrease>;
/**
 * Credit behavior when quantity decreases mid-cycle.
 */
declare const AttachOnDecrease: {
 ...
 * Credit behavior when quantity decreases mid-cycle.
 */
type AttachOnDecrease = ClosedEnum<typeof AttachOnDecrease>;
/**
 * Proration settings for prepaid features. Controls mid-cycle quantity change billing.
 */
type AttachProration = {
    /**
     * Billing behavior when quantity increases mid-cycle.
     */
 ...
 */
declare const AttachExpiryDurationType: {
    readonly Month: "month";
 ...
 * When rolled over units expire.
 */
type AttachExpiryDurationType = ClosedEnum<typeof AttachExpiryDurationType>;
/**
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
declare const BillingUpdateResetInterval: {
    readonly OneOff: "one_off";
    readonly Minute: "minute";
    readonly Hour: "hour";
    readonly Day: "day";
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
type BillingUpdateResetInterval = ClosedEnum<typeof BillingUpdateResetInterval>;
/**
 * Reset configuration for consumable features. Omit for non-consumable features like seats.
 */
type BillingUpdateReset = {
    /**
     * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
     */
...
type BillingUpdateTier = {
    to: number | string;
    amount?: number | undefined;
    flatAmount?: number | undefined;
};
declare const BillingUpdateTierBehavior: {
    readonly Graduated: "graduated";
    readonly Volume: "volume";
};
type BillingUpdateTierBehavior = ClosedEnum<typeof BillingUpdateTierBehavior>;
/**
 * Billing interval. For consumable features, should match reset.interval.
 */
 ...
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
declare const BillingUpdateBillingMethod: {
    readonly Prepaid: "prepaid";
    readonly UsageBased: "usage_based";
};
/**
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
type BillingUpdateBillingMethod = ClosedEnum<typeof BillingUpdateBillingMethod>;
/**
 * Pricing for usage beyond included units. Omit for free features.
 */
type BillingUpdatePrice = {
    /**
     * Price per billing_units after included usage. Either 'amount' or 'tiers' is required.
     */
    amount?: number | undefined;
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
declare const BillingUpdateOnIncrease: {
    readonly BillImmediately: "bill_immediately";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly BillNextCycle: "bill_next_cycle";
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
type BillingUpdateOnIncrease = ClosedEnum<typeof BillingUpdateOnIncrease>;
/**
 * Credit behavior when quantity decreases mid-cycle.
 */
declare const BillingUpdateOnDecrease: {
    readonly Prorate: "prorate";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly None: "none";
 ...
 * Credit behavior when quantity decreases mid-cycle.
 */
type BillingUpdateOnDecrease = ClosedEnum<typeof BillingUpdateOnDecrease>;
/**
 * Proration settings for prepaid features. Controls mid-cycle quantity change billing.
 */
type BillingUpdateProration = {
    /**
     * Billing behavior when quantity increases mid-cycle.
     */
 ...
 * When rolled over units expire.
 */
declare const BillingUpdateExpiryDurationType: {
    readonly Month: "month";
    readonly Forever: "forever";
};
/**
 * When rolled over units expire.
 */
type BillingUpdateExpiryDurationType = ClosedEnum<typeof BillingUpdateExpiryDurationType>;
/**
 * Rollover config for unused units. If set, unused included units carry over.
 */
type BillingUpdateRollover = {
    /**
     * Max rollover units. Omit for unlimited rollover.
     */
    max?: number | undefined;
 ...
 */
declare const CustomerDataInterval: {
    readonly Hour: "hour";
    readonly Day: "day";
    readonly Week: "week";
    readonly Month: "month";
 ...
 * The time interval for the purchase limit window.
 */
type CustomerDataInterval = ClosedEnum<typeof CustomerDataInterval>;
/**
 ...
 */
declare const CreateFeatureTypeRequest: {
    readonly Boolean: "boolean";
    readonly Metered: "metered";
    readonly CreditSystem: "credit_system";
};
 ...
 * The type of the feature. 'single_use' features are consumed, like API calls, tokens, or messages. 'continuous_use' features are allocated, like seats, workspaces, or projects. 'credit_system' features are schemas that unify multiple 'single_use' features into a single credit system.
 */
type CreateFeatureTypeRequest = ClosedEnum<typeof CreateFeatureTypeRequest>;
/**
 * Singular and plural display names for the feature in your user interface.
 */
type CreateFeatureDisplayRequest = {
    singular: string;
    plural: string;
};
type CreateFeatureCreditSchemaRequest = {
    meteredFeatureId: string;
    creditCost: number;
};
 ...
 * Billing interval (e.g. 'month', 'year').
 */
declare const CreatePlanPriceIntervalRequest: {
    readonly OneOff: "one_off";
    readonly Week: "week";
    readonly Month: "month";
    readonly Quarter: "quarter";
 ...
 * Billing interval (e.g. 'month', 'year').
 */
type CreatePlanPriceIntervalRequest = ClosedEnum<typeof CreatePlanPriceIntervalRequest>;
/**
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
declare const CreatePlanResetIntervalRequest: {
    readonly OneOff: "one_off";
    readonly Minute: "minute";
    readonly Hour: "hour";
    readonly Day: "day";
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
type CreatePlanResetIntervalRequest = ClosedEnum<typeof CreatePlanResetIntervalRequest>;
/**
 * Reset configuration for consumable features. Omit for non-consumable features like seats.
 */
type CreatePlanResetRequest = {
    /**
     * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
     */
...
declare const CreatePlanTierBehaviorRequest: {
    readonly Graduated: "graduated";
    readonly Volume: "volume";
};
type CreatePlanTierBehaviorRequest = ClosedEnum<typeof CreatePlanTierBehaviorRequest>;
/**
 * Billing interval. For consumable features, should match reset.interval.
 */
declare const CreatePlanItemPriceIntervalRequest: {
    readonly OneOff: "one_off";
    readonly Week: "week";
    readonly Month: "month";
    readonly Quarter: "quarter";
 ...
 * Billing interval. For consumable features, should match reset.interval.
 */
type CreatePlanItemPriceIntervalRequest = ClosedEnum<typeof CreatePlanItemPriceIntervalRequest>;
/**
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
declare const CreatePlanBillingMethodRequest: {
    readonly Prepaid: "prepaid";
    readonly UsageBased: "usage_based";
};
/**
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
type CreatePlanBillingMethodRequest = ClosedEnum<typeof CreatePlanBillingMethodRequest>;
/**
 * Pricing for usage beyond included units. Omit for free features.
 */
type CreatePlanItemPriceRequest = {
    /**
     * Price per billing_units after included usage. Either 'amount' or 'tiers' is required.
     */
    amount?: number | undefined;
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
declare const CreatePlanOnIncrease: {
    readonly BillImmediately: "bill_immediately";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly BillNextCycle: "bill_next_cycle";
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
type CreatePlanOnIncrease = ClosedEnum<typeof CreatePlanOnIncrease>;
/**
 * Credit behavior when quantity decreases mid-cycle.
 */
declare const CreatePlanOnDecrease: {
    readonly Prorate: "prorate";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly None: "none";
 ...
 * Credit behavior when quantity decreases mid-cycle.
 */
type CreatePlanOnDecrease = ClosedEnum<typeof CreatePlanOnDecrease>;
/**
 * Proration settings for prepaid features. Controls mid-cycle quantity change billing.
 */
 ...
 * When rolled over units expire.
 */
declare const CreatePlanExpiryDurationTypeRequest: {
    readonly Month: "month";
    readonly Forever: "forever";
};
/**
 * When rolled over units expire.
 */
type CreatePlanExpiryDurationTypeRequest = ClosedEnum<typeof CreatePlanExpiryDurationTypeRequest>;
/**
 * Rollover config for unused units. If set, unused included units carry over.
 */
type CreatePlanRolloverRequest = {
    /**
     * Max rollover units. Omit for unlimited rollover.
     */
    max?: number | undefined;
 ...
 * The interval at which the feature balance resets (e.g. 'month', 'year'). For consumable features, usage resets to 0 and included units are restored.
 */
declare const CreatePlanResetIntervalResponse: {
    readonly OneOff: "one_off";
    readonly Minute: "minute";
    readonly Hour: "hour";
    readonly Day: "day";
 ...
 * The interval at which the feature balance resets (e.g. 'month', 'year'). For consumable features, usage resets to 0 and included units are restored.
 */
type CreatePlanResetIntervalResponse = OpenEnum<typeof CreatePlanResetIntervalResponse>;
type CreatePlanResetResponse = {
    /**
     * The interval at which the feature balance resets (e.g. 'month', 'year'). For consumable features, usage resets to 0 and included units are restored.
     */
...
declare const CreatePlanTierBehaviorResponse: {
    readonly Graduated: "graduated";
    readonly Volume: "volume";
};
type CreatePlanTierBehaviorResponse = OpenEnum<typeof CreatePlanTierBehaviorResponse>;
/**
 * Billing interval for this price. For consumable features, should match reset.interval.
 */
 ...
 * 'prepaid' for features like seats where customers pay upfront, 'usage_based' for pay-as-you-go after included usage.
 */
declare const CreatePlanBillingMethodResponse: {
    readonly Prepaid: "prepaid";
    readonly UsageBased: "usage_based";
};
/**
 * 'prepaid' for features like seats where customers pay upfront, 'usage_based' for pay-as-you-go after included usage.
 */
type CreatePlanBillingMethodResponse = OpenEnum<typeof CreatePlanBillingMethodResponse>;
 ...
 * When rolled over units expire.
 */
declare const CreatePlanExpiryDurationTypeResponse: {
    readonly Month: "month";
    readonly Forever: "forever";
};
/**
 * When rolled over units expire.
 */
type CreatePlanExpiryDurationTypeResponse = OpenEnum<typeof CreatePlanExpiryDurationTypeResponse>;
/**
 * Rollover configuration for unused units. If set, unused included units roll over to the next period.
 */
type CreatePlanRolloverResponse = {
    /**
     * Maximum rollover units. Null for unlimited rollover.
     */
    max: number | null;
 ...
 * The environment (sandbox/live)
 */
type EntityEnv = OpenEnum<typeof EntityEnv>;
type Entity = {
    /**
     * The unique identifier of the entity
     */
 ...
 * The type of reward
 */
type RewardsType = OpenEnum<typeof RewardsType>;
/**
 ...
 * Use 'confirm' to commit the deduction, or 'release' to return the held balance.
 */
type Action = ClosedEnum<typeof Action>;
 ...
 * The interval at which the feature balance resets (e.g. 'month', 'year'). For consumable features, usage resets to 0 and included units are restored.
 */
declare const GetPlanResetInterval: {
    readonly OneOff: "one_off";
    readonly Minute: "minute";
    readonly Hour: "hour";
    readonly Day: "day";
 ...
 * The interval at which the feature balance resets (e.g. 'month', 'year'). For consumable features, usage resets to 0 and included units are restored.
 */
type GetPlanResetInterval = OpenEnum<typeof GetPlanResetInterval>;
type GetPlanReset = {
    /**
     * The interval at which the feature balance resets (e.g. 'month', 'year'). For consumable features, usage resets to 0 and included units are restored.
     */
...
declare const GetPlanTierBehavior: {
    readonly Graduated: "graduated";
    readonly Volume: "volume";
};
type GetPlanTierBehavior = OpenEnum<typeof GetPlanTierBehavior>;
/**
 * Billing interval for this price. For consumable features, should match reset.interval.
 */
 ...
 * 'prepaid' for features like seats where customers pay upfront, 'usage_based' for pay-as-you-go after included usage.
 */
declare const GetPlanBillingMethod: {
    readonly Prepaid: "prepaid";
    readonly UsageBased: "usage_based";
};
/**
 * 'prepaid' for features like seats where customers pay upfront, 'usage_based' for pay-as-you-go after included usage.
 */
type GetPlanBillingMethod = OpenEnum<typeof GetPlanBillingMethod>;
 ...
 * When rolled over units expire.
 */
declare const GetPlanExpiryDurationType: {
    readonly Month: "month";
    readonly Forever: "forever";
};
/**
 * When rolled over units expire.
 */
type GetPlanExpiryDurationType = OpenEnum<typeof GetPlanExpiryDurationType>;
/**
 * Rollover configuration for unused units. If set, unused included units roll over to the next period.
 */
type GetPlanRollover = {
    /**
     * Maximum rollover units. Null for unlimited rollover.
     */
    max: number | null;
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
declare const PreviewAttachResetInterval: {
    readonly OneOff: "one_off";
    readonly Minute: "minute";
    readonly Hour: "hour";
    readonly Day: "day";
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
type PreviewAttachResetInterval = ClosedEnum<typeof PreviewAttachResetInterval>;
/**
 * Reset configuration for consumable features. Omit for non-consumable features like seats.
 */
type PreviewAttachReset = {
    /**
     * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
     */
...
declare const PreviewAttachTierBehavior: {
    readonly Graduated: "graduated";
    readonly Volume: "volume";
};
type PreviewAttachTierBehavior = ClosedEnum<typeof PreviewAttachTierBehavior>;
/**
 * Billing interval. For consumable features, should match reset.interval.
 */
 ...
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
declare const PreviewAttachBillingMethod: {
    readonly Prepaid: "prepaid";
    readonly UsageBased: "usage_based";
};
/**
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
type PreviewAttachBillingMethod = ClosedEnum<typeof PreviewAttachBillingMethod>;
/**
 * Pricing for usage beyond included units. Omit for free features.
 */
type PreviewAttachPrice = {
    /**
     * Price per billing_units after included usage. Either 'amount' or 'tiers' is required.
     */
    amount?: number | undefined;
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
declare const PreviewAttachOnIncrease: {
    readonly BillImmediately: "bill_immediately";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly BillNextCycle: "bill_next_cycle";
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
type PreviewAttachOnIncrease = ClosedEnum<typeof PreviewAttachOnIncrease>;
/**
 * Credit behavior when quantity decreases mid-cycle.
 */
declare const PreviewAttachOnDecrease: {
    readonly Prorate: "prorate";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly None: "none";
 ...
 * Credit behavior when quantity decreases mid-cycle.
 */
type PreviewAttachOnDecrease = ClosedEnum<typeof PreviewAttachOnDecrease>;
/**
 * Proration settings for prepaid features. Controls mid-cycle quantity change billing.
 */
type PreviewAttachProration = {
    /**
     * Billing behavior when quantity increases mid-cycle.
     */
 ...
 * When rolled over units expire.
 */
declare const PreviewAttachExpiryDurationType: {
    readonly Month: "month";
    readonly Forever: "forever";
};
/**
 * When rolled over units expire.
 */
type PreviewAttachExpiryDurationType = ClosedEnum<typeof PreviewAttachExpiryDurationType>;
/**
 * Rollover config for unused units. If set, unused included units carry over.
 */
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
declare const PreviewUpdateResetInterval: {
    readonly OneOff: "one_off";
    readonly Minute: "minute";
    readonly Hour: "hour";
    readonly Day: "day";
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
type PreviewUpdateResetInterval = ClosedEnum<typeof PreviewUpdateResetInterval>;
/**
 * Reset configuration for consumable features. Omit for non-consumable features like seats.
 */
type PreviewUpdateReset = {
    /**
     * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
     */
...
type PreviewUpdateTier = {
    to: number | string;
    amount?: number | undefined;
    flatAmount?: number | undefined;
};
declare const PreviewUpdateTierBehavior: {
    readonly Graduated: "graduated";
    readonly Volume: "volume";
};
type PreviewUpdateTierBehavior = ClosedEnum<typeof PreviewUpdateTierBehavior>;
/**
 * Billing interval. For consumable features, should match reset.interval.
 */
 ...
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
declare const PreviewUpdateBillingMethod: {
    readonly Prepaid: "prepaid";
    readonly UsageBased: "usage_based";
};
/**
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
type PreviewUpdateBillingMethod = ClosedEnum<typeof PreviewUpdateBillingMethod>;
/**
 * Pricing for usage beyond included units. Omit for free features.
 */
type PreviewUpdatePrice = {
    /**
     * Price per billing_units after included usage. Either 'amount' or 'tiers' is required.
     */
    amount?: number | undefined;
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
declare const PreviewUpdateOnIncrease: {
    readonly BillImmediately: "bill_immediately";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly BillNextCycle: "bill_next_cycle";
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
type PreviewUpdateOnIncrease = ClosedEnum<typeof PreviewUpdateOnIncrease>;
/**
 * Credit behavior when quantity decreases mid-cycle.
 */
declare const PreviewUpdateOnDecrease: {
    readonly Prorate: "prorate";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly None: "none";
 ...
 * Credit behavior when quantity decreases mid-cycle.
 */
type PreviewUpdateOnDecrease = ClosedEnum<typeof PreviewUpdateOnDecrease>;
/**
 * Proration settings for prepaid features. Controls mid-cycle quantity change billing.
 */
 ...
 * When rolled over units expire.
 */
declare const PreviewUpdateExpiryDurationType: {
    readonly Month: "month";
    readonly Forever: "forever";
};
/**
 * When rolled over units expire.
 */
type PreviewUpdateExpiryDurationType = ClosedEnum<typeof PreviewUpdateExpiryDurationType>;
/**
 * Rollover config for unused units. If set, unused included units carry over.
 */
type PreviewUpdateRollover = {
    /**
     * Max rollover units. Omit for unlimited rollover.
     */
    max?: number | undefined;
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
declare const SetupPaymentResetInterval: {
    readonly OneOff: "one_off";
    readonly Minute: "minute";
    readonly Hour: "hour";
    readonly Day: "day";
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
type SetupPaymentResetInterval = ClosedEnum<typeof SetupPaymentResetInterval>;
/**
 * Reset configuration for consumable features. Omit for non-consumable features like seats.
 */
type SetupPaymentReset = {
    /**
     * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
     */
...
type SetupPaymentTier = {
    to: number | string;
    amount?: number | undefined;
    flatAmount?: number | undefined;
};
declare const SetupPaymentTierBehavior: {
    readonly Graduated: "graduated";
    readonly Volume: "volume";
};
type SetupPaymentTierBehavior = ClosedEnum<typeof SetupPaymentTierBehavior>;
/**
 * Billing interval. For consumable features, should match reset.interval.
 */
 ...
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
declare const SetupPaymentBillingMethod: {
    readonly Prepaid: "prepaid";
    readonly UsageBased: "usage_based";
};
/**
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
type SetupPaymentBillingMethod = ClosedEnum<typeof SetupPaymentBillingMethod>;
/**
 * Pricing for usage beyond included units. Omit for free features.
 */
type SetupPaymentPrice = {
    /**
     * Price per billing_units after included usage. Either 'amount' or 'tiers' is required.
     */
    amount?: number | undefined;
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
declare const SetupPaymentOnIncrease: {
    readonly BillImmediately: "bill_immediately";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly BillNextCycle: "bill_next_cycle";
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
type SetupPaymentOnIncrease = ClosedEnum<typeof SetupPaymentOnIncrease>;
/**
 * Credit behavior when quantity decreases mid-cycle.
 */
declare const SetupPaymentOnDecrease: {
    readonly Prorate: "prorate";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly None: "none";
 ...
 * Credit behavior when quantity decreases mid-cycle.
 */
type SetupPaymentOnDecrease = ClosedEnum<typeof SetupPaymentOnDecrease>;
/**
 * Proration settings for prepaid features. Controls mid-cycle quantity change billing.
 */
type SetupPaymentProration = {
    /**
     * Billing behavior when quantity increases mid-cycle.
     */
 ...
 * When rolled over units expire.
 */
declare const SetupPaymentExpiryDurationType: {
    readonly Month: "month";
    readonly Forever: "forever";
};
/**
 * When rolled over units expire.
 */
type SetupPaymentExpiryDurationType = ClosedEnum<typeof SetupPaymentExpiryDurationType>;
/**
 * Rollover config for unused units. If set, unused included units carry over.
 */
type SetupPaymentRollover = {
    /**
     * Max rollover units. Omit for unlimited rollover.
     */
    max?: number | undefined;
 ...
 * The time interval for the purchase limit window.
 */
declare const UpdateCustomerIntervalRequest: {
    readonly Hour: "hour";
    readonly Day: "day";
    readonly Week: "week";
    readonly Month: "month";
 ...
 * The time interval for the purchase limit window.
 */
type UpdateCustomerIntervalRequest = ClosedEnum<typeof UpdateCustomerIntervalRequest>;
/**
 * Optional rate limit to cap how often auto top-ups occur.
 */
 ...
 * The type of the feature. 'single_use' features are consumed, like API calls, tokens, or messages. 'continuous_use' features are allocated, like seats, workspaces, or projects. 'credit_system' features are schemas that unify multiple 'single_use' features into a single credit system.
 */
declare const UpdateFeatureTypeRequest: {
    readonly Boolean: "boolean";
    readonly Metered: "metered";
    readonly CreditSystem: "credit_system";
};
 ...
 * The type of the feature. 'single_use' features are consumed, like API calls, tokens, or messages. 'continuous_use' features are allocated, like seats, workspaces, or projects. 'credit_system' features are schemas that unify multiple 'single_use' features into a single credit system.
 */
type UpdateFeatureTypeRequest = ClosedEnum<typeof UpdateFeatureTypeRequest>;
/**
 * Singular and plural display names for the feature in your user interface.
 */
type UpdateFeatureDisplayRequest = {
    singular: string;
    plural: string;
};
 ...
 * Billing interval (e.g. 'month', 'year').
 */
declare const UpdatePlanPriceIntervalRequest: {
    readonly OneOff: "one_off";
    readonly Week: "week";
    readonly Month: "month";
    readonly Quarter: "quarter";
 ...
 * Billing interval (e.g. 'month', 'year').
 */
type UpdatePlanPriceIntervalRequest = ClosedEnum<typeof UpdatePlanPriceIntervalRequest>;
/**
 * Base price configuration for a plan.
 */
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
declare const UpdatePlanResetIntervalRequest: {
    readonly OneOff: "one_off";
    readonly Minute: "minute";
    readonly Hour: "hour";
    readonly Day: "day";
 ...
 * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
 */
type UpdatePlanResetIntervalRequest = ClosedEnum<typeof UpdatePlanResetIntervalRequest>;
/**
 * Reset configuration for consumable features. Omit for non-consumable features like seats.
 */
type UpdatePlanResetRequest = {
    /**
     * Interval at which balance resets (e.g. 'month', 'year'). For consumable features only.
     */
...
declare const UpdatePlanTierBehaviorRequest: {
    readonly Graduated: "graduated";
    readonly Volume: "volume";
};
type UpdatePlanTierBehaviorRequest = ClosedEnum<typeof UpdatePlanTierBehaviorRequest>;
/**
 * Billing interval. For consumable features, should match reset.interval.
 */
declare const UpdatePlanItemPriceIntervalRequest: {
    readonly OneOff: "one_off";
    readonly Week: "week";
    readonly Month: "month";
    readonly Quarter: "quarter";
 ...
 * Billing interval. For consumable features, should match reset.interval.
 */
type UpdatePlanItemPriceIntervalRequest = ClosedEnum<typeof UpdatePlanItemPriceIntervalRequest>;
/**
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
declare const UpdatePlanBillingMethodRequest: {
    readonly Prepaid: "prepaid";
    readonly UsageBased: "usage_based";
};
/**
 * 'prepaid' for upfront payment (seats), 'usage_based' for pay-as-you-go.
 */
type UpdatePlanBillingMethodRequest = ClosedEnum<typeof UpdatePlanBillingMethodRequest>;
/**
 * Pricing for usage beyond included units. Omit for free features.
 */
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
declare const UpdatePlanOnIncrease: {
    readonly BillImmediately: "bill_immediately";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly BillNextCycle: "bill_next_cycle";
 ...
 * Billing behavior when quantity increases mid-cycle.
 */
type UpdatePlanOnIncrease = ClosedEnum<typeof UpdatePlanOnIncrease>;
/**
 * Credit behavior when quantity decreases mid-cycle.
 */
declare const UpdatePlanOnDecrease: {
    readonly Prorate: "prorate";
    readonly ProrateImmediately: "prorate_immediately";
    readonly ProrateNextCycle: "prorate_next_cycle";
    readonly None: "none";
 ...
 * Credit behavior when quantity decreases mid-cycle.
 */
type UpdatePlanOnDecrease = ClosedEnum<typeof UpdatePlanOnDecrease>;
/**
 * Proration settings for prepaid features. Controls mid-cycle quantity change billing.
 */
type UpdatePlanProration = {
    /**
     * Billing behavior when quantity increases mid-cycle.
     */
 ...
 * When rolled over units expire.
 */
declare const UpdatePlanExpiryDurationTypeRequest: {
    readonly Month: "month";
    readonly Forever: "forever";
};
/**
 * When rolled over units expire.
 */
type UpdatePlanExpiryDurationTypeRequest = ClosedEnum<typeof UpdatePlanExpiryDurationTypeRequest>;
/**
 * Rollover config for unused units. If set, unused included units carry over.
 */
type UpdatePlanRolloverRequest = {
    /**
     * Max rollover units. Omit for unlimited rollover.
     */
    max?: number | undefined;
 ...
 * Free trial configuration for a plan.
 */
type UpdatePlanFreeTrialParams = {
    /**
     * Number of duration_type periods the trial lasts.
     */
    durationLength: number;
 ...
 * The interval at which the feature balance resets (e.g. 'month', 'year'). For consumable features, usage resets to 0 and included units are restored.
 */
declare const UpdatePlanResetIntervalResponse: {
    readonly OneOff: "one_off";
    readonly Minute: "minute";
    readonly Hour: "hour";
    readonly Day: "day";
 ...
 * The interval at which the feature balance resets (e.g. 'month', 'year'). For consumable features, usage resets to 0 and included units are restored.
 */
type UpdatePlanResetIntervalResponse = OpenEnum<typeof UpdatePlanResetIntervalResponse>;
type UpdatePlanResetResponse = {
    /**
     * The interval at which the feature balance resets (e.g. 'month', 'year'). For consumable features, usage resets to 0 and included units are restored.
     */
...
declare const UpdatePlanTierBehaviorResponse: {
    readonly Graduated: "graduated";
    readonly Volume: "volume";
};
type UpdatePlanTierBehaviorResponse = OpenEnum<typeof UpdatePlanTierBehaviorResponse>;
/**
 * Billing interval for this price. For consumable features, should match reset.interval.
 */
 ...
 * 'prepaid' for features like seats where customers pay upfront, 'usage_based' for pay-as-you-go after included usage.
 */
declare const UpdatePlanBillingMethodResponse: {
    readonly Prepaid: "prepaid";
    readonly UsageBased: "usage_based";
};
/**
 * 'prepaid' for features like seats where customers pay upfront, 'usage_based' for pay-as-you-go after included usage.
 */
type UpdatePlanBillingMethodResponse = OpenEnum<typeof UpdatePlanBillingMethodResponse>;
 ...
 * When rolled over units expire.
 */
declare const UpdatePlanExpiryDurationTypeResponse: {
    readonly Month: "month";
    readonly Forever: "forever";
};
/**
 * When rolled over units expire.
 */
type UpdatePlanExpiryDurationTypeResponse = OpenEnum<typeof UpdatePlanExpiryDurationTypeResponse>;
/**
 * Rollover configuration for unused units. If set, unused included units roll over to the next period.
 */
type UpdatePlanRolloverResponse = {
    /**
     * Maximum rollover units. Null for unlimited rollover.
     */
    max: number | null;
...
declare class Customers extends ClientSDK {
     ...
     */
    list(request?: ListCustomersParams | undefined, options?: RequestOptions): Promise<ListCustomersResponse>;
    /**
