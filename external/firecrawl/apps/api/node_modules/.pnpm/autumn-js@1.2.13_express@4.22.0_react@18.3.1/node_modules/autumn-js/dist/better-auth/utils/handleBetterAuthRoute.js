...
var handleBetterAuthRoute_exports = {};
__export(handleBetterAuthRoute_exports, {
  createHandleBetterAuthRoute: () => createHandleBetterAuthRoute
});
module.exports = __toCommonJS(handleBetterAuthRoute_exports);
...
var createHandleBetterAuthRoute = ({
  ...
  return async ({ ctx, routeName }) => {
    const session = await (0, import_api.getSessionFromCtx)(
      ctx
    );
