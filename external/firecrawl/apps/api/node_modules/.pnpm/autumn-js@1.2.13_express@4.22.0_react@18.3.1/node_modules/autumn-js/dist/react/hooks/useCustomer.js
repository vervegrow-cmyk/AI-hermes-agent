...
var useCustomerActions = ({
  ...
  const attach = (0, import_react2.useCallback)(
    async (params) => {
  ...
  const previewAttach = (0, import_react2.useCallback)(
    async (params) => {
      return client.previewAttach(params);
    },
    [client]
  );
  const updateSubscription = (0, import_react2.useCallback)(
    async (params) => {
  ...
  const previewUpdateSubscription = (0, import_react2.useCallback)(
    async (params) => {
      return client.previewUpdateSubscription(params);
    },
    [client]
  );
  const check = (0, import_react2.useCallback)(
    (params) => {
  ...
  const openCustomerPortal = (0, import_react2.useCallback)(
    async (params = {}) => {
  ...
  const multiAttach = (0, import_react2.useCallback)(
    async (params) => {
  ...
  const previewMultiAttach = (0, import_react2.useCallback)(
    async (params) => {
      return client.previewMultiAttach(params);
    },
    [client]
  );
  const setupPayment = (0, import_react2.useCallback)(
    async (params = {}) => {
