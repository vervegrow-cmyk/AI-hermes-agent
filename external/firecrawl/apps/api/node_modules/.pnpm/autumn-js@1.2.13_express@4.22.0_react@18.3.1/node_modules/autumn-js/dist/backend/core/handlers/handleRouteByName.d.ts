...
declare const handleRouteByName: ({ routeName, body, identify, secretKey, autumnURL, }: HandleRouteByNameOptions) => Promise<HandleRouteByNameResult>;

export { type HandleRouteByNameOptions, type HandleRouteByNameResult, handleRouteByName };
