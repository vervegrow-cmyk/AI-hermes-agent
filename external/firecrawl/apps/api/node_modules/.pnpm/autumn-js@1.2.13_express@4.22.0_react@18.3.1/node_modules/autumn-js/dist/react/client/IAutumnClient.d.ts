...
interface IAutumnClient {
    getOrCreateCustomer: (params?: ClientGetOrCreateCustomerParams) => Promise<Customer | null>;
    ...
    getEntity: (params: ClientGetEntityParams) => Promise<GetEntityResponse>;
}

export type { IAutumnClient };
